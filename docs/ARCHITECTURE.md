...
`StellaRuntime` 作为唯一 composition root，只构造并持有一个 `PresentationDirector`。Stage、dialogue visibility、dialogue content clear、chapter indicator、persistent loop-SE 与 BGM 都通过这个 owner/lifecycle 边界：
